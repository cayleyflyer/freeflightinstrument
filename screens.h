...
public:
  Screen()
    : hasStatusBar(false), hasMap(false), hasMainScreen(false), hasScreenThree(false){};  //added hasmainscreen  for screen2 and screen3 5/12/24
  bool hasStatusBar, hasMap, hasMainScreen, hasScreenThree;                               //added hasmainscreen  for screen2 and screen3 5/12/24
...
private:
  ...
  ScreenText _SoftwareVersion = ScreenText(cols[0], rows[5], textSize, "XC_InstrumentTFT");
