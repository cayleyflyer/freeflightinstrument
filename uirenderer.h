...
private:
    ...
    unsigned long _tLastRender, _tLoopRender, _samplealtitude ;  // added  _samplealtitude to set flag when to in the tloop render routine
    char* _textBuffer;
    ...
    void renderVarioScreen();                    // added for screen2 5/12/24
    void renderVarioStat(char* textBuff);        // added for screen2 5/12/24
